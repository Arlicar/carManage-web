	...
	<view class="content">
		...
		<view class="main">
			<form>
				...
				<view class="uni-flex uni-column card"
					style="height: 60rpx;width: 80rpx;margin-top: 0;margin-left: 520rpx;">
					<text
						style="color: #DD524D;height: 100%;width: 100%;line-height: 60rpx;font-weight: 600;text-align: center;"
						@click="remove">清除</text>
				</view>
		...
		methods: {
			...
			submit() {
				...
				uni.uploadFile({
					...
					formData: {
						no: _this.$store.state.userInfo.no,
						repairLicense: _this.licenseArray[_this.index]
							.license,
