	...
	export default {
		...
		methods: {
			getList() {
				let _this = this;
				uni.request({
					url: _this.apiServer + "/api/get/getAll/sendCarDeclare",
					method: 'POST',
					header: {
