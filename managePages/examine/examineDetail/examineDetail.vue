...
<!-- 				<text class="intro">维修单编号：{{list.repairId}}</text> -->
				<text class="intro">申报人姓名：{{list.surveyName? list.surveyName:list.manageName}}</text>
				...
				<text
					class="intro">操作时间：{{new Date(parseInt(list.surveyTime)).toLocaleString().replace(/:\d{1,2}$/,' ')}}</text>
			</view>
