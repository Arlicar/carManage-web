	...
	<view class="content">
		...
		<view class="chart">
			<view class="charts-box">
				<qiun-data-charts type="column" :chartData="chartData" :loadingType="5" :errorShow="false"
					:echartsH5="true" :echartsApp="true" :canvas2d="true" background="none" />
			</view>
		</view>
		<!-- ---- -->
		<tabBar :pagePath="'pages/vet/index/index'"></tabBar>
		<text class="btn" @click="showMap">点击显示车辆位置信息</text>
...
<script>
	import carMap from '../../common/carMap.vue'
	export default {
		components: {
			carMap
		},
